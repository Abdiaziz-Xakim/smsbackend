...
#             terms = (
#                 AcademicYearForm.objects.filter(current=True)
...
#             initial={
#                 "current_session": AcademicYear.objects.get(current=True),
...
#             AcademicYear.objects.filter(name=session).update(current=True)
#             AcademicYear.objects.exclude(name=session).update(current=False)
